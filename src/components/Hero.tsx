...
export const Hero: React.FC = () => {
  ...
  return (
    <section id="hero" className="relative overflow-hidden pt-6 pb-12">
      ...
      <div className="w-full max-w-5xl mx-auto rounded-3xl overflow-hidden border border-sky-900/40 shadow-2xl mb-8 bg-slate-900">
        <img
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        <div className="text-center">
          ...
          <div className="h-10 flex items-center justify-center font-mono text-base sm:text-xl font-medium text-sky-400 mb-6">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 mb-10">
            <a
              ...
              href="#projects"
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-sky-500 hover:bg-sky-400 text-slate-950 font-bold text-sm shadow-lg shadow-sky-500/25 transition-all hover:scale-[1.02]"
            >
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-slate-800 hover:bg-slate-700 text-white font-medium text-sm border border-slate-700 transition-all hover:scale-[1.02]"
            >
